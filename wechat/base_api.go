...
func (w *Client) UnifiedOrder(ctx context.Context, bm pay.BodyMap) (wxRsp *UnifiedOrderResponse, err error) {
...
func (w *Client) Micropay(ctx context.Context, bm pay.BodyMap) (wxRsp *MicropayResponse, err error) {
...
func (w *Client) QueryOrder(ctx context.Context, bm pay.BodyMap) (wxRsp *QueryOrderResponse, resBm pay.BodyMap, err error) {
...
func (w *Client) CloseOrder(ctx context.Context, bm pay.BodyMap) (wxRsp *CloseOrderResponse, err error) {
...
func (w *Client) Refund(ctx context.Context, bm pay.BodyMap) (wxRsp *RefundResponse, resBm pay.BodyMap, err error) {
...
func (w *Client) QueryRefund(ctx context.Context, bm pay.BodyMap) (wxRsp *QueryRefundResponse, resBm pay.BodyMap, err error) {
	err = bm.CheckEmptyError("nonce_str")
	if err != nil {
		return nil, nil, err
	}
...
func (w *Client) Reverse(ctx context.Context, bm pay.BodyMap) (wxRsp *ReverseResponse, err error) {
	err = bm.CheckEmptyError("nonce_str", "out_trade_no")
	if err != nil {
		return nil, err
	}
