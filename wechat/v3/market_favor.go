...
func (c *ClientV3) V3FavorBatchCreate(ctx context.Context, bm pay.BodyMap) (wxRsp *FavorBatchCreateRsp, err error) {
...
func (c *ClientV3) V3FavorBatchGrant(ctx context.Context, openid string, bm pay.BodyMap) (wxRsp *FavorBatchGrantRsp, err error) {
...
func (c *ClientV3) V3FavorBatchList(ctx context.Context, bm pay.BodyMap) (wxRsp *FavorBatchListRsp, err error) {
...
func (c *ClientV3) V3FavorUserCoupons(ctx context.Context, openid string, bm pay.BodyMap) (wxRsp *FavorUserCouponsRsp, err error) {
...
func (c *ClientV3) V3FavorCallbackUrlSet(ctx context.Context, bm pay.BodyMap) (wxRsp *FavorCallbackUrlSetRsp, err error) {
