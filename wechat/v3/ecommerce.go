...
func (c *ClientV3) V3EcommerceApply(ctx context.Context, bm pay.BodyMap) (*EcommerceApplyRsp, error) {
...
func (c *ClientV3) V3EcommerceApplyStatus(ctx context.Context, applyId int64, outRequestNo string) (*EcommerceApplyStatusRsp, error) {
	if applyId == 0 && outRequestNo == pay.NULL {
...
func (c *ClientV3) V3EcommerceProfitShare(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareQuery(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareQueryRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareReturn(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareReturnRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareReturnResult(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareReturnResultRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareFinish(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareFinishRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareAddReceiver(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareAddReceiverRsp, error) {
...
func (c *ClientV3) V3EcommerceProfitShareDeleteReceiver(ctx context.Context, bm pay.BodyMap) (*EcommerceProfitShareDeleteReceiverRsp, error) {
...
func (c *ClientV3) V3EcommerceSubsidies(ctx context.Context, bm pay.BodyMap) (*EcommerceSubsidiesRsp, error) {
...
func (c *ClientV3) V3EcommerceSubsidiesReturn(ctx context.Context, bm pay.BodyMap) (*EcommerceSubsidiesReturnRsp, error) {
...
func (c *ClientV3) V3EcommerceSubsidiesCancel(ctx context.Context, bm pay.BodyMap) (*EcommerceSubsidiesCancelRsp, error) {
