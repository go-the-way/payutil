...
func (c *ClientV3) V3PartnershipsBuild(ctx context.Context, idempotencyKey string, bm pay.BodyMap) (wxRsp *PartnershipsBuildRsp, err error) {
...
func (c *ClientV3) V3PartnershipsTerminate(ctx context.Context, idempotencyKey string, bm pay.BodyMap) (wxRsp *PartnershipsTerminateRsp, err error) {
...
func (c *ClientV3) V3PartnershipsList(ctx context.Context, bm pay.BodyMap) (wxRsp *PartnershipsListRsp, err error) {
