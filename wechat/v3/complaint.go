...
func (c *ClientV3) V3ComplaintList(ctx context.Context, bm pay.BodyMap) (wxRsp *ComplaintListRsp, err error) {
...
func (c *ClientV3) V3ComplaintNegotiationHistory(ctx context.Context, complaintId string, bm pay.BodyMap) (wxRsp *ComplaintNegotiationHistoryRsp, err error) {
...
func (c *ClientV3) V3ComplaintResponse(ctx context.Context, complaintId string, bm pay.BodyMap) (wxRsp *EmptyRsp, err error) {
...
func (c *ClientV3) V3ComplaintComplete(ctx context.Context, complaintId string, bm pay.BodyMap) (wxRsp *EmptyRsp, err error) {
