...
func (c *ClientV3) V3ScoreDirectComplete(ctx context.Context, bm pay.BodyMap) (wxRsp *ScoreDirectCompleteRsp, err error) {
...
func (c *ClientV3) V3ScorePermission(ctx context.Context, bm pay.BodyMap) (wxRsp *ScorePermissionRsp, err error) {
...
func (c *ClientV3) V3ScoreOrderCreate(ctx context.Context, bm pay.BodyMap) (wxRsp *ScoreOrderCreateRsp, err error) {
...
func (c *ClientV3) V3ScoreOrderModify(ctx context.Context, tradeNo string, bm pay.BodyMap) (wxRsp *ScoreOrderModifyRsp, err error) {
...
func (c *ClientV3) V3ScoreOrderComplete(ctx context.Context, tradeNo string, bm pay.BodyMap) (wxRsp *ScoreOrderCompleteRsp, err error) {
...
func (c *ClientV3) V3ScoreOrderSync(ctx context.Context, tradeNo string, bm pay.BodyMap) (wxRsp *ScoreOrderSyncRsp, err error) {
