...
func (c *ClientV3) V3BusiFavorBatchCreate(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorCreateRsp, err error) {
...
func (c *ClientV3) V3BusiFavorUse(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorUseRsp, err error) {
...
func (c *ClientV3) V3BusiFavorUserCoupons(ctx context.Context, openid string, bm pay.BodyMap) (wxRsp *BusiFavorUserCouponsRsp, err error) {
...
func (c *ClientV3) V3BusiFavorCodeUpload(ctx context.Context, stockId string, bm pay.BodyMap) (wxRsp *BusiFavorCodeUploadRsp, err error) {
...
func (c *ClientV3) V3BusiFavorCallbackUrlSet(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorCallbackUrlSetRsp, err error) {
...
func (c *ClientV3) V3BusiFavorAssociate(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorAssociateRsp, err error) {
...
func (c *ClientV3) V3BusiFavorDisassociate(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorDisassociateRsp, err error) {
...
func (c *ClientV3) V3BusiFavorBatchUpdate(ctx context.Context, stockId string, bm pay.BodyMap) (wxRsp *BusiFavorBatchUpdateRsp, err error) {
...
func (c *ClientV3) V3BusiFavorInfoUpdate(ctx context.Context, stockId string, bm pay.BodyMap) (wxRsp *EmptyRsp, err error) {
...
func (c *ClientV3) V3BusiFavorSend(ctx context.Context, cardId string, bm pay.BodyMap) (wxRsp *BusiFavorSendRsp, err error) {
...
func (c *ClientV3) V3BusiFavorReturn(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorReturnRsp, err error) {
...
func (c *ClientV3) V3BusiFavorDeactivate(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorDeactivateRsp, err error) {
...
func (c *ClientV3) V3BusiFavorSubsidyPay(ctx context.Context, bm pay.BodyMap) (wxRsp *BusiFavorSubsidyPayRsp, err error) {
