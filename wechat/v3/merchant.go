...
func (c *ClientV3) V3EcommerceBalance(ctx context.Context, subMchid string, bm pay.BodyMap) (*EcommerceBalanceRsp, error) {
...
func (c *ClientV3) V3EcommerceIncomeRecord(ctx context.Context, bm pay.BodyMap) (*PartnerIncomeRecordRsp, error) {
...
func (c *ClientV3) V3MerchantIncomeRecord(ctx context.Context, bm pay.BodyMap) (*MerchantIncomeRecordRsp, error) {
