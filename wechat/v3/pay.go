...
func (c *ClientV3) V3TransactionApp(ctx context.Context, bm pay.BodyMap) (wxRsp *PrepayRsp, err error) {
...
func (c *ClientV3) V3TransactionJsapi(ctx context.Context, bm pay.BodyMap) (wxRsp *PrepayRsp, err error) {
	if bm.GetString("mchid") == util.NULL {
		bm.Set("mchid", c.Mchid)
	}
...
func (c *ClientV3) V3TransactionNative(ctx context.Context, bm pay.BodyMap) (wxRsp *NativeRsp, err error) {
	if bm.GetString("mchid") == util.NULL {
		bm.Set("mchid", c.Mchid)
	}
...
func (c *ClientV3) V3TransactionH5(ctx context.Context, bm pay.BodyMap) (wxRsp *H5Rsp, err error) {
	if bm.GetString("mchid") == util.NULL {
		bm.Set("mchid", c.Mchid)
	}
