...
func (c *ClientV3) V3Refund(ctx context.Context, bm pay.BodyMap) (wxRsp *RefundRsp, err error) {
...
func (c *ClientV3) V3RefundQuery(ctx context.Context, outRefundNo string, bm pay.BodyMap) (wxRsp *RefundQueryRsp, err error) {
...
func (c *ClientV3) V3EcommerceRefund(ctx context.Context, bm pay.BodyMap) (wxRsp *EcommerceRefundRsp, err error) {
...
func (c *ClientV3) V3EcommerceRefundQueryById(ctx context.Context, refundId string, bm pay.BodyMap) (wxRsp *EcommerceRefundQueryRsp, err error) {
...
//	Code = 0 is success
//	电商文档：https://pay.weixin.qq.com/wiki/doc/apiv3_partner/apis/chapter7_6_2.shtml
func (c *ClientV3) V3EcommerceRefundQueryByNo(ctx context.Context, outRefundNo string, bm pay.BodyMap) (wxRsp *EcommerceRefundQueryRsp, err error) {
...
func (c *ClientV3) V3EcommerceRefundAdvance(ctx context.Context, refundId string, bm pay.BodyMap) (wxRsp *EcommerceRefundAdvanceRsp, err error) {
...
func (c *ClientV3) V3EcommerceRefundAdvanceResult(ctx context.Context, refundId string, bm pay.BodyMap) (wxRsp *EcommerceRefundAdvanceRsp, err error) {
