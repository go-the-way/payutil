...
func (c *ClientV3) V3ProfitShareOrder(ctx context.Context, bm pay.BodyMap) (*ProfitShareOrderRsp, error) {
...
func (c *ClientV3) V3ProfitShareOrderQuery(ctx context.Context, orderNo string, bm pay.BodyMap) (*ProfitShareOrderQueryRsp, error) {
...
func (c *ClientV3) V3ProfitShareReturn(ctx context.Context, bm pay.BodyMap) (*ProfitShareReturnRsp, error) {
...
func (c *ClientV3) V3ProfitShareReturnResult(ctx context.Context, returnNo string, bm pay.BodyMap) (*ProfitShareReturnResultRsp, error) {
...
func (c *ClientV3) V3ProfitShareOrderUnfreeze(ctx context.Context, bm pay.BodyMap) (*ProfitShareOrderUnfreezeRsp, error) {
...
func (c *ClientV3) V3ProfitShareAddReceiver(ctx context.Context, bm pay.BodyMap) (*ProfitShareAddReceiverRsp, error) {
...
func (c *ClientV3) V3ProfitShareDeleteReceiver(ctx context.Context, bm pay.BodyMap) (*ProfitShareDeleteReceiverRsp, error) {
...
func (c *ClientV3) V3ProfitShareBills(ctx context.Context, bm pay.BodyMap) (*ProfitShareBillsRsp, error) {
