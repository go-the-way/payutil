...
func (c *ClientV3) V3DiscountCardApply(ctx context.Context, bm pay.BodyMap) (wxRsp *DiscountCardApplyRsp, err error) {
...
func (c *ClientV3) V3DiscountCardAddUser(ctx context.Context, bm pay.BodyMap) (wxRsp *EmptyRsp, err error) {
