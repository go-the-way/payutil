...
func (c *ClientV3) V3SmartGuideReg(ctx context.Context, bm pay.BodyMap) (wxRsp *SmartGuideRegRsp, err error) {
...
func (c *ClientV3) V3SmartGuideQuery(ctx context.Context, bm pay.BodyMap) (wxRsp *SmartGuideQueryRsp, err error) {
...
func (c *ClientV3) V3SmartGuideUpdate(ctx context.Context, guideId string, bm pay.BodyMap) (wxRsp *EmptyRsp, err error) {
