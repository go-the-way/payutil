...
func (c *ClientV3) V3Withdraw(ctx context.Context, bm pay.BodyMap) (*WithdrawRsp, error) {
...
func (c *ClientV3) V3WithdrawStatus(ctx context.Context, withdrawId, outRequestNo string, bm pay.BodyMap) (*WithdrawStatusRsp, error) {
	if withdrawId == pay.NULL && outRequestNo == pay.NULL {
		return nil, fmt.Errorf("[%w]: withdrawId[%s] and outRequestNo[%s] empty at the same time", pay.MissParamErr, withdrawId, outRequestNo)
	}
	var uri string
	if withdrawId != pay.NULL {
...
func (c *ClientV3) V3EcommerceWithdraw(ctx context.Context, bm pay.BodyMap) (*EcommerceWithdrawRsp, error) {
...
func (c *ClientV3) V3WithdrawDownloadErrBill(ctx context.Context, bm pay.BodyMap) (wxRsp *BillRsp, err error) {
	if bm != nil {
