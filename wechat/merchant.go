...
func (w *Client) Transfer(ctx context.Context, bm pay.BodyMap) (wxRsp *TransfersResponse, err error) {
...
func (w *Client) GetTransferInfo(ctx context.Context, bm pay.BodyMap) (wxRsp *TransfersInfoResponse, err error) {
...
func (w *Client) PayBank(ctx context.Context, bm pay.BodyMap) (wxRsp *PayBankResponse, err error) {
...
func (w *Client) QueryBank(ctx context.Context, bm pay.BodyMap) (wxRsp *QueryBankResponse, err error) {
	if err = bm.CheckEmptyError("nonce_str", "partner_trade_no"); err != nil {
		return nil, err
	}
	bm.Set("mch_id", w.MchId)
...
func (w *Client) GetRSAPublicKey(ctx context.Context, bm pay.BodyMap) (wxRsp *RSAPublicKeyResponse, err error) {
...
func (w *Client) ProfitSharing(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingResponse, err error) {
...
// 注意：请在初始化client时，调用 client 添加证书的相关方法添加证书
// 文档地址：https://pay.weixin.qq.com/wiki/doc/api/allocation.php?chapter=27_1&index=1
func (w *Client) MultiProfitSharing(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingResponse, err error) {
	return w.profitSharing(ctx, bm, multiProfitSharing)
}

func (w *Client) profitSharing(ctx context.Context, bm pay.BodyMap, uri string) (wxRsp *ProfitSharingResponse, err error) {
...
func (w *Client) ProfitSharingQuery(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingQueryResponse, err error) {
...
func (w *Client) ProfitSharingAddReceiver(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingAddReceiverResponse, err error) {
...
func (w *Client) ProfitSharingRemoveReceiver(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingAddReceiverResponse, err error) {
	err = bm.CheckEmptyError("nonce_str", "receiver")
	if err != nil {
		return nil, err
	}
...
func (w *Client) ProfitSharingFinish(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingResponse, err error) {
...
func (w *Client) ProfitSharingReturn(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingReturnResponse, err error) {
...
func (w *Client) ProfitSharingReturnQuery(ctx context.Context, bm pay.BodyMap) (wxRsp *ProfitSharingReturnResponse, err error) {
