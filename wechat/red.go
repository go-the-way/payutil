...
func (w *Client) SendCashRed(ctx context.Context, bm pay.BodyMap) (wxRsp *SendCashRedResponse, err error) {
...
func (w *Client) SendGroupCashRed(ctx context.Context, bm pay.BodyMap) (wxRsp *SendCashRedResponse, err error) {
...
func (w *Client) SendAppletRed(ctx context.Context, bm pay.BodyMap) (wxRsp *SendAppletRedResponse, err error) {
...
func (w *Client) QueryRedRecord(ctx context.Context, bm pay.BodyMap) (wxRsp *QueryRedRecordResponse, err error) {
