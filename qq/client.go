...
func (q *Client) PostQQAPISelf(ctx context.Context, bm pay.BodyMap, url string, tlsConfig *tls.Config) (bs []byte, err error) {
	return q.doQQ(ctx, bm, url, tlsConfig)
}

// 提交付款码支付
// 文档地址：https://qpay.qq.com/buss/wiki/1/1122
func (q *Client) MicroPay(ctx context.Context, bm pay.BodyMap) (qqRsp *MicroPayResponse, err error) {
...
func (q *Client) Reverse(ctx context.Context, bm pay.BodyMap) (qqRsp *ReverseResponse, err error) {
...
func (q *Client) UnifiedOrder(ctx context.Context, bm pay.BodyMap) (qqRsp *UnifiedOrderResponse, err error) {
...
func (q *Client) OrderQuery(ctx context.Context, bm pay.BodyMap) (qqRsp *OrderQueryResponse, err error) {
...
func (q *Client) CloseOrder(ctx context.Context, bm pay.BodyMap) (qqRsp *CloseOrderResponse, err error) {
...
func (q *Client) Refund(ctx context.Context, bm pay.BodyMap, certFilePath, keyFilePath, pkcs12FilePath interface{}) (qqRsp *RefundResponse, err error) {
...
func (q *Client) RefundQuery(ctx context.Context, bm pay.BodyMap) (qqRsp *RefundQueryResponse, err error) {
	err = bm.CheckEmptyError("nonce_str")
	if err != nil {
		return nil, err
	}
...
func (q *Client) StatementDown(ctx context.Context, bm pay.BodyMap) (qqRsp string, err error) {
...
func (q *Client) AccRoll(ctx context.Context, bm pay.BodyMap) (qqRsp string, err error) {
...
// 向QQ发送请求
func (q *Client) doQQ(ctx context.Context, bm pay.BodyMap, url string, tlsConfig *tls.Config) (bs []byte, err error) {
...
// Get请求、正式
func (q *Client) doQQGet(ctx context.Context, bm pay.BodyMap, url, signType string) (bs []byte, err error) {
	if bm.GetString("mch_id") == util.NULL {
		bm.Set("mch_id", q.MchId)
	}
	bm.Remove("sign")
...
func (q *Client) doQQRed(ctx context.Context, bm pay.BodyMap, url string, tlsConfig *tls.Config) (bs []byte, err error) {
