...
func (a *Client) KoubeiTradeOrderAggregateConsult(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeOrderAggregateConsultRsp, err error) {
...
func (a *Client) KoubeiTradeOrderPrecreate(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeOrderPrecreateRsp, err error) {
...
func (a *Client) KoubeiTradeItemorderBuy(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeItemorderBuyRsp, err error) {
...
func (a *Client) KoubeiTradeOrderConsult(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeOrderConsultRsp, err error) {
...
func (a *Client) KoubeiTradeItemorderRefund(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeItemorderRefundRsp, err error) {
...
func (a *Client) KoubeiTradeItemorderQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeItemorderQueryRsp, err error) {
...
func (a *Client) KoubeiTradeTicketTicketcodeSend(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeTicketTicketcodeSendRsp, err error) {
...
func (a *Client) KoubeiTradeTicketTicketcodeDelay(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeTicketTicketcodeDelayRsp, err error) {
...
func (a *Client) KoubeiTradeTicketTicketcodeQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeTicketTicketcodeQueryRsp, err error) {
...
func (a *Client) KoubeiTradeTicketTicketcodeCancel(ctx context.Context, bm pay.BodyMap) (aliRsp *KoubeiTradeTicketTicketcodeCancelRsp, err error) {
