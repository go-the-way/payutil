...
func (a *Client) ZhimaCreditScoreGet(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditScoreGetResponse, err error) {
...
func (a *Client) ZhimaCreditEpSceneRatingInitialize(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditEpSceneRatingInitializeRsp, err error) {
	if bm.GetString("product_code") == util.NULL {
		bm.Set("product_code", "w1010100100000000001")
	}
...
func (a *Client) ZhimaCreditEpSceneFulfillmentSync(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditEpSceneFulfillmentSyncRsp, err error) {
...
func (a *Client) ZhimaCreditEpSceneAgreementUse(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditEpSceneAgreementUseRsp, err error) {
...
func (a *Client) ZhimaCreditEpSceneAgreementCancel(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditEpSceneAgreementCancelRsp, err error) {
...
func (a *Client) ZhimaCreditEpSceneFulfillmentlistSync(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditEpSceneFulfillmentlistSyncRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoCumulationSync(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoCumulationSyncRsp, err error) {
...
func (a *Client) ZhimaMerchantZmgoCumulateSync(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaMerchantZmgoCumulateSyncRsp, err error) {
...
func (a *Client) ZhimaMerchantZmgoCumulateQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaMerchantZmgoCumulateQueryRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoBizoptClose(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoBizoptCloseRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoSettleRefund(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoSettleRefundRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoPreorderCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoPreorderCreateRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoAgreementUnsign(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoAgreementUnsignRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoAgreementQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoAgreementQueryRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoSettleUnfreeze(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoSettleUnfreezeRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoPaysignApply(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoPaysignApplyRsp, err error) {
...
func (a *Client) ZhimaCreditPeZmgoPaysignConfirm(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCreditPeZmgoPaysignConfirmRsp, err error) {
...
func (a *Client) ZhimaCustomerJobworthAdapterQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCustomerJobworthAdapterQueryRsp, err error) {
	var bs []byte
...
func (a *Client) ZhimaCustomerJobworthSceneUse(ctx context.Context, bm pay.BodyMap) (aliRsp *ZhimaCustomerJobworthSceneUseRsp, err error) {
	var bs []byte
