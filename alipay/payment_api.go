...
func (a *Client) TradePay(ctx context.Context, bm pay.BodyMap) (aliRsp *TradePayResponse, err error) {
...
func (a *Client) TradePrecreate(ctx context.Context, bm pay.BodyMap) (aliRsp *TradePrecreateResponse, err error) {
...
func (a *Client) TradeAppPay(ctx context.Context, bm pay.BodyMap) (payParam string, err error) {
	err = bm.CheckEmptyError("out_trade_no", "total_amount", "subject")
	if err != nil {
...
func (a *Client) TradeWapPay(ctx context.Context, bm pay.BodyMap) (payUrl string, err error) {
...
func (a *Client) TradePagePay(ctx context.Context, bm pay.BodyMap) (payUrl string, err error) {
...
func (a *Client) TradeCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeCreateResponse, err error) {
	err = bm.CheckEmptyError("out_trade_no", "total_amount", "subject")
	if err != nil {
		return nil, err
	}
...
func (a *Client) TradeQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeQueryResponse, err error) {
...
func (a *Client) TradeCancel(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeCancelResponse, err error) {
	if bm.GetString("out_trade_no") == util.NULL && bm.GetString("trade_no") == util.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
	var bs []byte
...
func (a *Client) TradeClose(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeCloseResponse, err error) {
	if bm.GetString("out_trade_no") == util.NULL && bm.GetString("trade_no") == util.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
	var bs []byte
...
func (a *Client) TradeRefund(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeRefundResponse, err error) {
	if bm.GetString("out_trade_no") == util.NULL && bm.GetString("trade_no") == util.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
...
func (a *Client) TradePageRefund(ctx context.Context, bm pay.BodyMap) (aliRsp *TradePageRefundResponse, err error) {
	if bm.GetString("out_trade_no") == util.NULL && bm.GetString("trade_no") == util.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
...
func (a *Client) TradeFastPayRefundQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeFastpayRefundQueryResponse, err error) {
	if bm.GetString("out_trade_no") == util.NULL && bm.GetString("trade_no") == util.NULL {
		return nil, errors.New("out_trade_no and trade_no are not allowed to be null at the same time")
	}
...
func (a *Client) TradeOrderInfoSync(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeOrderInfoSyncRsp, err error) {
...
func (a *Client) TradeAdvanceConsult(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeAdvanceConsultRsp, err error) {
	var bs []byte
...
func (a *Client) PcreditHuabeiAuthSettleApply(ctx context.Context, bm pay.BodyMap) (aliRsp *PcreditHuabeiAuthSettleApplyRsp, err error) {
...
func (a *Client) CommerceTransportNfccardSend(ctx context.Context, bm pay.BodyMap) (aliRsp *CommerceTransportNfccardSendRsp, err error) {
...
func (a *Client) DataDataserviceAdDataQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *DataDataserviceAdDataQueryRsp, err error) {
...
func (a *Client) CommerceAirCallcenterTradeApply(ctx context.Context, bm pay.BodyMap) (aliRsp *CommerceAirCallcenterTradeApplyRsp, err error) {
...
func (a *Client) PaymentTradeOrderCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *PaymentTradeOrderCreateRsp, err error) {
...
func (a *Client) CommerceBenefitApply(ctx context.Context, bm pay.BodyMap) (aliRsp *CommerceBenefitApplyRsp, err error) {
...
func (a *Client) CommerceBenefitVerify(ctx context.Context, bm pay.BodyMap) (aliRsp *CommerceBenefitVerifyRsp, err error) {
...
func (a *Client) TradeRepaybillQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *TradeRepaybillQueryRsp, err error) {
	var bs []byte
