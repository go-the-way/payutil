...
func (a *Client) FundTransUniTransfer(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransUniTransferResponse, err error) {
...
func (a *Client) FundAccountQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAccountQueryResponse, err error) {
...
func (a *Client) FundTransCommonQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransCommonQueryResponse, err error) {
	var bs []byte
...
func (a *Client) FundTransOrderQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransOrderQueryResponse, err error) {
	// 两个请求参数不能同时为空
...
func (a *Client) FundTransRefund(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransRefundResponse, err error) {
...
func (a *Client) FundAuthOrderFreeze(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAuthOrderFreezeResponse, err error) {
...
func (a *Client) FundAuthOrderVoucherCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAuthOrderVoucherCreateResponse, err error) {
...
func (a *Client) FundAuthOrderAppFreeze(ctx context.Context, bm pay.BodyMap) (payParam string, err error) {
	err = bm.CheckEmptyError("out_order_no", "out_request_no", "order_title", "amount", "product_code")
	if err != nil {
...
func (a *Client) FundAuthOrderUnfreeze(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAuthOrderUnfreezeResponse, err error) {
...
func (a *Client) FundAuthOperationDetailQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAuthOperationDetailQueryResponse, err error) {
	var bs []byte
...
func (a *Client) FundAuthOperationCancel(ctx context.Context, bm pay.BodyMap) (aliRsp *FundAuthOperationCancelResponse, err error) {
...
func (a *Client) FundBatchCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *FundBatchCreateResponse, err error) {
...
func (a *Client) FundBatchClose(ctx context.Context, bm pay.BodyMap) (aliRsp *FundBatchCloseResponse, err error) {
...
func (a *Client) FundBatchDetailQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundBatchDetailQueryResponse, err error) {
	err = bm.CheckEmptyError("biz_scene")
	if err != nil {
		return nil, err
	}
...
func (a *Client) FundTransAppPay(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransAppPayResponse, err error) {
...
func (a *Client) FundTransPayeeBindQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransPayeeBindQueryRsp, err error) {
...
func (a *Client) FundTransPagePay(ctx context.Context, bm pay.BodyMap) (aliRsp *FundTransPagePayRsp, err error) {
	err = bm.CheckEmptyError("out_biz_no", "trans_amount", "product_code", "biz_scene")
	if err != nil {
		return nil, err
	}
