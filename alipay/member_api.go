...
func (a *Client) UserCertifyOpenInit(ctx context.Context, bm pay.BodyMap) (aliRsp *UserCertifyOpenInitResponse, err error) {
...
func (a *Client) UserCertifyOpenCertify(ctx context.Context, bm pay.BodyMap) (certifyUrl string, err error) {
...
func (a *Client) UserCertifyOpenQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserCertifyOpenQueryResponse, err error) {
	err = bm.CheckEmptyError("certify_id")
	if err != nil {
		return nil, err
	}
...
func (a *Client) UserAgreementPageSign(ctx context.Context, bm pay.BodyMap) (ret string, err error) {
...
func (a *Client) UserAgreementPageUnSign(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAgreementPageUnSignRsp, err error) {
	var bs []byte
...
func (a *Client) UserAgreementQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAgreementQueryRsp, err error) {
	var bs []byte
...
func (a *Client) UserAgreementExecutionplanModify(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAgreementExecutionplanModifyRsp, err error) {
...
func (a *Client) UserAgreementTransfer(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAgreementTransferRsp, err error) {
...
func (a *Client) UserTwostageCommonUse(ctx context.Context, bm pay.BodyMap) (aliRsp *UserTwostageCommonUseRsp, err error) {
...
func (a *Client) UserAuthZhimaorgIdentityApply(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAuthZhimaorgIdentityApplyRsp, err error) {
...
func (a *Client) UserCharityRecordexistQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserCharityRecordexistQueryRsp, err error) {
...
func (a *Client) UserAlipaypointSend(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAlipaypointSendRsp, err error) {
...
func (a *Client) MemberDataIsvCreate(ctx context.Context, bm pay.BodyMap) (aliRsp *MemberDataIsvCreateRsp, err error) {
...
func (a *Client) UserFamilyArchiveQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserFamilyArchiveQueryRsp, err error) {
...
func (a *Client) UserFamilyArchiveInitialize(ctx context.Context, bm pay.BodyMap) (aliRsp *UserFamilyArchiveInitializeRsp, err error) {
...
func (a *Client) UserCertdocCertverifyPreconsult(ctx context.Context, bm pay.BodyMap) (aliRsp *UserCertdocCertverifyPreconsultRsp, err error) {
...
func (a *Client) UserCertdocCertverifyConsult(ctx context.Context, bm pay.BodyMap, authToken string) (aliRsp *UserCertdocCertverifyConsultRsp, err error) {
	var bs []byte
...
func (a *Client) UserFamilyShareZmgoInitialize(ctx context.Context, bm pay.BodyMap) (aliRsp *UserFamilyShareZmgoInitializeRsp, err error) {
...
func (a *Client) UserDtbankQrcodedataQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserDtbankQrcodedataQueryRsp, err error) {
...
func (a *Client) UserAlipaypointBudgetlibQuery(ctx context.Context, bm pay.BodyMap) (aliRsp *UserAlipaypointBudgetlibQueryRsp, err error) {
