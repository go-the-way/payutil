...
func (a *Client) UserInfoAuth(ctx context.Context, bm pay.BodyMap) (aliRsp *UserInfoAuthResponse, err error) {
...
func (a *Client) SystemOauthToken(ctx context.Context, bm pay.BodyMap) (aliRsp *SystemOauthTokenResponse, err error) {
...
func (a *Client) OpenAuthTokenApp(ctx context.Context, bm pay.BodyMap) (aliRsp *OpenAuthTokenAppResponse, err error) {
	if bm.GetString("code") == util.NULL && bm.GetString("refresh_token") == util.NULL {
		return nil, errors.New("code and refresh_token are not allowed to be null at the same time")
	}
	err = bm.CheckEmptyError("grant_type")
...
func (a *Client) PublicCertDownload(ctx context.Context, bm pay.BodyMap) (aliRsp *PublicCertDownloadRsp, err error) {
